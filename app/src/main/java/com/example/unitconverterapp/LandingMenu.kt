...
fun LandingMenu(navigateToLength:()->Unit,
      ...
      LazyVerticalGrid(GridCells.Fixed(3),modifier=Modifier.fillMaxSize().padding(16.dp),
            verticalArrangement = Arrangement.Center ){
            item{
                  Card(modifier=Modifier.padding(8.dp)  .width(cardWidth.dp)
            ...
            item{
                  Card(modifier=Modifier.padding(8.dp)  .width(cardWidth.dp)
                        ...
                        Column(modifier=Modifier.padding(4.dp).fillMaxSize(),
                              verticalArrangement = Arrangement.Center,
                              horizontalAlignment = Alignment.CenterHorizontally) {
                              Image(painter = painterResource(id =R.drawable.temperature), contentDescription = "Length",modifier=Modifier
                                    .height(80.dp)
                                    .width(80.dp))
                              Text(text = "Temperature")
                        }
