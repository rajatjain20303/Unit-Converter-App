...
fun  DataConversion(){
      Column(modifier= Modifier.fillMaxSize(),
            ...
            var inputUnit by remember { mutableStateOf("Bytes") }
            var outputUnit by remember { mutableStateOf("Bytes") }
            ...
            fun convert(){
                  ...
                  val res= BigDecimal(result).setScale(13, RoundingMode.HALF_EVEN)
//                  result=BigDecimal(3.14159265359).setScale(2, RoundingMode.HALF_EVEN)
                  outputValue=res.toString()
            }

            Spacer(modifier = Modifier.height(16.dp))
            Image(painter = painterResource(id =R.drawable.data), contentDescription = "Length",modifier= Modifier
                  .height(150.dp)
                  .width(150.dp)
                  .padding(16.dp))
            Spacer(modifier = Modifier.height(8.dp))

            Text(text = "Data Conversion", style = MaterialTheme.typography.headlineLarge)
                  ...
                  Box(modifier = Modifier)
                  {
                        Button(onClick = { iexpand=true}) {
                              ...
                              DropdownMenu(expanded = iexpand, onDismissRequest = { iexpand=false }) {
                                    ...
                                    DropdownMenuItem(
                                          text = { Text(text = "Megabytes (Mb)") },
                                          onClick = {
                                                inputUnit="Mb"
                                                iconversion.value=1000000.0
                                                iexpand=false
                                                convert() })
                                    DropdownMenuItem(
                                          text = { Text(text = "Gigabytes (Mb)") },
                                          onClick = {
                                                inputUnit="Gb"
                                                iconversion.value=1000000000.0
                                                iexpand=false
                                                convert()
                                          })
                                    DropdownMenuItem(
                                          text = { Text(text = "Terabytes (Tb)") },
                                          onClick = {
                                                inputUnit="Tb"
                                                iconversion.value=1000000000000.00
                                                iexpand=false
                                                convert() })
                              }
                        }
                        ...
                        Button(onClick = { oexpand=true }) {
                              ...
                              DropdownMenu(expanded = oexpand, onDismissRequest = { oexpand=false }) {
                                    ...
                                    DropdownMenuItem(
                                          ...
                                          onClick = {
                                                outputUnit="Mb"
                                                oconversion.value=1000000.0
                                                oexpand=false
                                                convert()
                                          })
                                    DropdownMenuItem(
                                          text = { Text(text = "Gigabytes (Gb)") },
                                          onClick = {
                                                outputUnit="Gb"
                                                oconversion.value=1000000000.0
                                                oexpand=false
                                                convert()
                                          })
                                    DropdownMenuItem(
                                          ...
                                          onClick = {
                                                outputUnit="Tb"
                                                oconversion.value=1000000000000.0
                                                oexpand=false
                                                convert()
                                          })
                              }
